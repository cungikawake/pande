        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                   <span class="text-left" style="font-size:18px;"><img src="{{ asset('images/research.png') }}" height="30"> Detail Tracer Medical Record</span>
                ...
                @endforeach 
                <div class="card-body">
                    <form class="form-horizontal" role="form" action="{{ route('tmr.update') }}" method="POST">
                    {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_ktp" class="form-control" id="no_ktp" value="{{ $tmrs->no_ktp }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_rm" class="form-control" id="no_rm" value="{{ $tmrs->no_rm }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="poli" class="form-control" placeholder="Poli peminjam" value="{{ $tmrs->poli }}">
                        </div>
                        <div class="form-group">
                            <label>Keterangan</labe>
                            <textarea class="form-control" name="keterangan">{{ $tmrs->keterangan }}</textarea>
                        </div>
                        <hr>
                        <br>
