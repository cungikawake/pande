        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                   <span class="text-left" style="font-size:18px;"><img src="{{ asset('images/patient.png') }}" height="30"> Tambah Pasien</span>
                ...
                @endforeach 
                <div class="card-body">
                    <form class="form-horizontal" role="form" action="{{ route('pasien.store') }}" method="POST">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tanggal_lahir" class="form-control"  value="{{ old('tanggal_lahir') }}">
                        <div>
                        <br>
